...
export function Maintenance() {
  return (
    <div className="w-full flex justify-center items-center min-h-[100vh] sm:min-h-[81vh] pb-10">
      <div className="flex flex-col gap-5 max-w-[707px] text-center">
        ...
        <Button
          to="/"
          className="min-h-[52px] lg:max-w-[747px] xl:max-w-[707px] w-full py-2 bg-black text-grayscale-white hover:opacity-80"
        >
