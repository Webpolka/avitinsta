...
export function CheckoutStart() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const orderPayload = {
        customer: { ...form },
        deliveryId: selectedDelivery, // сюда приходит выбранный способ доставки
        promo: promo,
      ...
      console.log("Заказ готов к отправке :", orderPayload);

      // Сохраняем draft заказа в LocalStorage
